...
public class AES {
    ...
    public String encrypt(final byte[] data) {
        try {
            ...
            return Base64.encodeToString(encryptData, 16);
...
//            byte[] byteArr = str.getBytes("utf-8");
            ...
            return decrypt(data);
//            return decrypt(org.apache.commons.codec.binary.Hex.decodeHex(str.toCharArray()));
//            return decrypt(DatatypeConverter.parseBase64Binary(str));
//            return Arrays.toString(Hex.decodeHex(str.toCharArray()));
        } catch (final Exception ex) {
            throw new RuntimeException(ex.getMessage());
        }
    }
...
//        String
//
//        String key = Cons.KEY_AES;
//        String iv = Cons.IV_AES;
//
//        AES aes = new AES(key, 128, iv);
//
//        String decrypted = aes.decrypt(encryptText);
//
//        return decrypted;
//
//    }
