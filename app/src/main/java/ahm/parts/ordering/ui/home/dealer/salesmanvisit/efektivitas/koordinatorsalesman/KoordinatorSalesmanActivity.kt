package ahm.parts.ordering.ui.home.dealer.salesmanvisit.efektivitas.koordinatorsalesman
...
class KoordinatorSalesmanActivity : BaseActivity<EfektivitasViewModel>(), ClickPrevention {
    ...
    override fun onClick(v: View?) {
        when(v!!){
            ...
            btnApplyDealer -> {
             ...
             /*   if(salesmanAdapter.koordinatorSelected != null){
                    setResult(Constants.RESULT.KOORDINATOR_SALESMAN){
                        putExtra(Constants.BUNDLE.JSON,salesmanAdapter.koordinatorSelected!!.getString())
                    }
                }else{
