package ahm.parts.ordering.ui.home.home.ordersugestion.kodedealer
...
class KodeDealerViewModel @Inject constructor(private val context : Application) : BaseViewModel(){
    ...
    fun hitKodeDealer(search : String) {
        ...
        apiResponse.postValue(ApiResponse().responseLoading(R.id.rvKodeDealer,R.id.swipeRefresh,isHideView = true))
            ...
            apiService.getKodeDealer(search)
                ...
                .subscribe({
                    ...
                    if (apiStatus == Constants.REMOTE.API_STATUS_SUCCESS) {
                        ...
                        apiResponse.postValue(ApiResponse().responseSuccess(apiMessage,R.id.rvKodeDealer,R.id.swipeRefresh,isHideView = true))
                        ...
                        apiResponse.postValue(ApiResponse().responseWrong(apiMessage,R.id.rvKodeDealer,R.id.swipeRefresh,isHideView = true))
                    }
                }, {
                    apiResponse.postValue(ApiResponse().responseError(it,R.id.rvKodeDealer,R.id.swipeRefresh,isHideView = true))
                })
        )
    }
