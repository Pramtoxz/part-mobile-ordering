package ahm.parts.ordering.ui.home.dealer.salesmanvisit.efektivitas.planactual.koordinator
...
class PlanActualEfektivitasCoordinatorActivity : BaseActivity<EfektivitasViewModel>(), View.OnClickListener {
    ...
    private fun hitApi(){
        ...
        paging = 1
        viewModel.hitEfektivitasPlanVisitCoordinator(paging,efektivitasPlanParam,false)
    }
    ...
    private fun initAdapter(){
        ...
        rvEfektivitas.onEndScroll(false){
            paging += 1
            viewModel.hitEfektivitasPlanVisitCoordinator(paging,efektivitasPlanParam,true)
        }
