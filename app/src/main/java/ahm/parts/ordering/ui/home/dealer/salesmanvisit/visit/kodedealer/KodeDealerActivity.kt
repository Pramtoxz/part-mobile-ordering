package ahm.parts.ordering.ui.home.dealer.salesmanvisit.visit.kodedealer
...
class KodeDealerActivity : BaseActivity<KodeDealerViewModel>(), View.OnClickListener {
    ...
    private fun initAdapter() {
        ...
        kodeDealerAdapter = rvKodeDealer.setAdapter(
            this,
            headerDealers,
            R.layout.item_header_kelompok_barang_search,
            {
                    ...
                    rvContent.setAdapter(
                        ...
                        },
                        {
                            setResult(Constants.RESULT.KODE_DEALER){
                                putExtra(Constants.BUNDLE.JSON,this@setAdapter.getString())
                            }
                        })
                } else {
                    rvContent.setAdapter(
