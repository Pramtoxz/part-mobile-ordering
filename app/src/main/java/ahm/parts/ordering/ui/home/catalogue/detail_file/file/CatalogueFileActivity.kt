...
import ahm.parts.ordering.ui.home.catalogue.adapter.CatalogueFileAdapter
...
class CatalogueFileActivity : BaseActivity<HomeViewModel>() {
    ...
    lateinit var catalogueAdapter: CatalogueFileAdapter
    ...
    private fun initUI() {
        ...
        rvList.apply {
            layoutManager = LinearLayoutManager(this@CatalogueFileActivity)
